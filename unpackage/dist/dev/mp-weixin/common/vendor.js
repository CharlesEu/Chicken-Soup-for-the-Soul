...
const toDisplayString = (val) => {
  return isString(val) ? val : val == null ? "" : isArray(val) || isObject$2(val) && (val.toString === objectToString$1 || !isFunction(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__23B3761",
    appName: "chicken-soup-业务布局篇",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "10.15.18.236,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_3-Hmqw";
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","10.15.18.236"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","C:/Users/DELL/Desktop/前端资料/HBuilderX.4.57.2025032507/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"soup-chicken-kt","spaceId":"mp-355d8529-2d32-4b1d-9cf9-4379112a6393","clientSecret":"LckrjTbgdpUPA4btkWYMcA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__23B3761";
} catch (e2) {
